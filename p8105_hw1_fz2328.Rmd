...
We can see that a same mean value of  `r mean(pull(Problem_2, var = vec_log))` is returned for the logical vector as it was before applying the `as.numeric` function. 

However, `NAs` are still returned for the character vector and factor vector, which is the same as before as well. 